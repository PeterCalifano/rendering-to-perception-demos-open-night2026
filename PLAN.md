...
- Pending corrective period batch: replace the older radar period with the OSIRIS-REx 2018 spacecraft measurement, rebuild both variants, rerun CTest, regenerate the GPU 1 phase-sweep clip, and review the three-file diff. Record its commit hash after committing.
